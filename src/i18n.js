...
(function() {
    ...
    const DICT = {
        en: {
            ...
            curator_locked_popup: "Ignore-queue editing lives in the on-page widget — press {keys} to switch back",
        ...
        de: {
            ...
            curator_locked_popup: "Die Bearbeitung der Ignorier-Warteschlange erfolgt im Seiten-Widget — drücke {keys}, um dorthin zurückzuwechseln",
        ...
        fr: {
            ...
            curator_locked_popup: "La gestion de la file des jeux à ignorer se fait dans le widget de la page — appuyez sur {keys} pour y revenir",
        ...
        es: {
            ...
            curator_locked_popup: "La edición de la cola de ignorados está en el widget de la página — pulsa {keys} para volver al widget",
        ...
        el: {
            ...
            curator_locked_popup: "Η επεξεργασία της ουράς αγνόησης γίνεται στο widget της σελίδας — πατήστε {keys} για επιστροφή στο widget",
        ...
        it: {
            ...
            curator_locked_popup: "La modifica della coda di ignorati avviene nel widget della pagina — premi {keys} per tornarci",
        ...
        'pt-BR': {
            ...
            curator_locked_popup: "A edição da fila de ignorados fica no widget da página — pressione {keys} para voltar ao widget",
        ...
        tr: {
            ...
            curator_locked_popup: "Yoksayma kuyruğu düzenlemesi sayfa widget'ında yapılır — widget'a dönmek için {keys} tuşlarına basın",
        ...
        ru: {
            ...
            curator_locked_popup: "Управление очередью скрытия — в виджете на странице. Нажмите {keys}, чтобы переключиться на него",
        ...
        uk: {
            ...
            curator_locked_popup: "Керування чергою приховування — у віджеті на сторінці. Натисніть {keys}, щоб перемкнутися на нього",
        ...
        pl: {
            ...
            curator_locked_popup: "Edycja kolejki ukrywania odbywa się w widżecie na stronie — naciśnij {keys}, aby do niego wrócić",
        ...
        cs: {
            ...
            curator_locked_popup: "Úpravy fronty skrývání probíhají ve widgetu na stránce — stiskněte {keys} pro přepnutí zpět na widget",
        ...
        hu: {
            ...
            curator_locked_popup: "A mellőzési sor szerkesztése az oldali widgetben történik — nyomd meg a {keys} billentyűket, hogy visszaválts rá",
        ...
        sr: {
            ...
            curator_locked_popup: "Uređivanje reda ignorisanja je u vidžetu na stranici — pritisnite {keys} da se vratite na njega",
        ...
        ro: {
            ...
            curator_locked_popup: "Editarea cozii de ignorare se face în widgetul din pagină — apăsați {keys} pentru a reveni la widget",
        ...
        ja: {
            ...
            curator_locked_popup: "無視キューの編集はページ上のウィジェットで行います — {keys} でウィジェットに戻せます",
        ...
        ko: {
            ...
            curator_locked_popup: "숨김 대기열 편집은 페이지 위젯에서 합니다 — {keys}를 눌러 위젯으로 돌아가세요",
        ...
        'zh-TW': {
            ...
            curator_locked_popup: "忽略佇列的編輯在頁面小工具中進行 — 按 {keys} 切換回小工具",
        ...
        th: {
            ...
            curator_locked_popup: "การแก้ไขคิวการซ่อนอยู่ในวิดเจ็ตบนหน้า — กด {keys} เพื่อกลับไปที่วิดเจ็ต",
