...
(function() {
    ...
    const DICT = {
        ...
        de: {
            ...
            curator_locked_popup: "Die Bearbeitung der Ignorier-Warteschlange erfolgt im Seiten-Widget — drücke {keys}, um zurückzuwechseln",
        ...
        fr: {
            ...
            curator_locked_popup: "La gestion de la file d'exclusion se fait dans le widget de la page — appuyez sur {keys} pour revenir",
        ...
        es: {
            ...
            curator_locked_popup: "La edición de la cola de ignorados está en el widget de la página — pulsa {keys} para volver",
        ...
        el: {
            ...
            curator_locked_popup: "Η επεξεργασία της ουράς αγνόησης γίνεται στο widget της σελίδας — πατήστε {keys} για επιστροφή",
        ...
        it: {
            ...
            curator_locked_popup: "La modifica della coda di esclusione avviene nel widget della pagina — premi {keys} per tornare",
        ...
        'pt-BR': {
            ...
            curator_locked_popup: "A edição da fila de ignorados fica no widget da página — pressione {keys} para voltar",
        ...
        tr: {
            ...
            curator_locked_popup: "Yoksayma kuyruğu düzenlemesi sayfa widget'ında yapılır — geri dönmek için {keys} tuşlarına basın",
        ...
        ru: {
            ...
            curator_locked_popup: "Управление очередью игнора доступно в виджете на странице — нажмите {keys}, чтобы вернуться",
        ...
        uk: {
            ...
            curator_locked_popup: "Керування чергою ігнору доступне у віджеті на сторінці — натисніть {keys}, щоб повернутися",
        ...
        pl: {
            ...
            curator_locked_popup: "Edycja kolejki ignorowania odbywa się w widżecie na stronie — naciśnij {keys}, aby wrócić",
        ...
        cs: {
            ...
            curator_locked_popup: "Úpravy fronty ignorování probíhají ve widgetu na stránce — stiskněte {keys} pro návrat",
        ...
        hu: {
            ...
            curator_locked_popup: "A mellőzési sor szerkesztése az oldali widgetben történik — nyomd meg a {keys} billentyűket a visszatéréshez",
        ...
        sr: {
            ...
            curator_locked_popup: "Уређивање реда за игнорисање је у виџету на страници — притисните {keys} да се вратите",
        ...
        ro: {
            ...
            curator_locked_popup: "Editarea cozii de ignorare se face în widgetul din pagină — apăsați {keys} pentru a reveni",
        ...
        ja: {
            ...
            curator_locked_popup: "無視キューの編集はページ上のウィジェットで行います — {keys} を押して戻ってください",
        ...
        ko: {
            ...
            curator_locked_popup: "무시 대기열 편집은 페이지 위젯에서 합니다 — {keys}를 눌러 돌아가세요",
        ...
        'zh-TW': {
            ...
            curator_locked_popup: "忽略佇列的編輯在頁面小工具中進行 — 按 {keys} 切換回去",
        ...
        th: {
            ...
            curator_locked_popup: "การแก้ไขคิวการเพิกเฉยอยู่ในวิดเจ็ตบนหน้า — กด {keys} เพื่อสลับกลับ",
