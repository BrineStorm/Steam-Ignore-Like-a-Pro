...
(function() {
    ...
    const DICT = {
        en: {
            ...
            curator_locked_popup: "Editing lives in the on-page widget — press {keys}",
        ...
        de: {
            ...
            curator_locked_popup: "Bearbeitung im Seiten-Widget — {keys} drücken",
        ...
        fr: {
            ...
            curator_locked_popup: "Édition dans le widget de la page — appuyez sur {keys}",
        ...
        es: {
            ...
            curator_locked_popup: "Edición en el widget de la página — pulsa {keys}",
        ...
        el: {
            ...
            curator_locked_popup: "Επεξεργασία στο widget της σελίδας — πατήστε {keys}",
        ...
        it: {
            ...
            curator_locked_popup: "Modifica nel widget della pagina — premi {keys}",
        ...
        'pt-BR': {
            ...
            curator_locked_popup: "Edição no widget da página — pressione {keys}",
        ...
        tr: {
            ...
            curator_locked_popup: "Düzenleme sayfa widget'ında — {keys} tuşuna basın",
        ...
        ru: {
            ...
            curator_locked_popup: "Редактирование — в виджете на странице. Нажмите {keys}",
        ...
        uk: {
            ...
            curator_locked_popup: "Редагування — у віджеті на сторінці. Натисніть {keys}",
        ...
        pl: {
            ...
            curator_locked_popup: "Edycja w widżecie na stronie — naciśnij {keys}",
        ...
        cs: {
            ...
            curator_locked_popup: "Úpravy ve widgetu na stránce — stiskněte {keys}",
        ...
        hu: {
            ...
            curator_locked_popup: "Szerkesztés az oldali widgetben — nyomd meg: {keys}",
        ...
        sr: {
            ...
            curator_locked_popup: "Uređivanje je u vidžetu na stranici — pritisnite {keys}",
        ...
        ro: {
            ...
            curator_locked_popup: "Editare în widgetul din pagină — apăsați {keys}",
        ...
        ja: {
            ...
            curator_locked_popup: "編集はページ上のウィジェットで — {keys} で戻せます",
        ...
        ko: {
            ...
            curator_locked_popup: "편집은 페이지 위젯에서 — {keys} 키로 전환",
        ...
        'zh-TW': {
            ...
            curator_locked_popup: "編輯在頁面小工具中 — 按 {keys} 切換",
        ...
        th: {
            ...
            curator_locked_popup: "แก้ไขในวิดเจ็ตบนหน้า — กด {keys}",
